...
INSERT INTO `production_batches` VALUES (1,1,'PB20260615001',1,100.0000,'doing',4,'2026-06-13','2026-06-16','2026-06-24 13:50:58',NULL,NULL,NULL,'2026-06-15 11:41:08',NULL,'2026-06-26 11:58:32',0,NULL,NULL),(2,2,'SCPC-20260617-001',1,80.0000,'doing',2,'2026-06-16','2026-06-17','2026-06-24 13:37:14',NULL,NULL,NULL,'2026-06-17 11:16:37',NULL,'2026-06-24 13:50:54',0,NULL,NULL);
...
INSERT INTO `refresh_tokens` VALUES (113,1,'3722b613-973f-42a5-a25a-3186d16693d5','2026-07-08 13:37:26','2026-07-01 13:37:26');
...
INSERT INTO `users` VALUES (1,1,'admin','$2a$10$lBhLsLyMmRFaviyRy6aiO.DZInv6MAHrm7qSp5OO.yyzD.zvsZgsO','系统管理员','admin@company.local',NULL,1,'2026-07-01 11:06:54','2026-06-11 11:47:00','2026-07-01 11:06:54',NULL),(2,2,'production_manager','$2a$10$lBhLsLyMmRFaviyRy6aiO.DZInv6MAHrm7qSp5OO.yyzD.zvsZgsO','生产主管','production.manager@company.local',NULL,1,NULL,'2026-06-11 11:47:00','2026-06-11 11:47:00',NULL),(3,2,'production_operator','$2a$10$lBhLsLyMmRFaviyRy6aiO.DZInv6MAHrm7qSp5OO.yyzD.zvsZgsO','生产操作员','production.operator@company.local',NULL,1,NULL,'2026-06-11 11:47:00','2026-06-11 11:47:00',NULL),(4,3,'quality_inspector','$2a$10$lBhLsLyMmRFaviyRy6aiO.DZInv6MAHrm7qSp5OO.yyzD.zvsZgsO','质量检验员','quality.inspector@company.local',NULL,1,NULL,'2026-06-11 11:47:00','2026-06-11 11:47:00',NULL);
...
-- Dump completed on 2026-07-01 13:39:36
-- Inventory stocktake permissions.
INSERT INTO `permissions` (`id`,`parent_id`,`name`,`code`,`type`,`route_path`,`api_method`,`api_path`,`sort_order`,`status`,`created_at`,`updated_at`,`deleted_at`) VALUES
-- 库存盘点台账权限：用于仓储管理下的盘点台账页面、目标下拉、登记盘点和确认调账。
INSERT INTO `permissions` (`id`,`parent_id`,`name`,`code`,`type`,`route_path`,`api_method`,`api_path`,`sort_order`,`status`,`created_at`,`updated_at`,`deleted_at`) VALUES
(256,100,'库存盘点台账','warehouse:stocktakes:view','page','/warehouse/stocktakes','GET','/warehouse/stocktakes',320,1,NOW(),NOW(),NULL),
(257,256,'库存盘点目标','warehouse:stocktakes:targets','api',NULL,'GET','/warehouse/stocktakes/targets',321,1,NOW(),NOW(),NULL),
(258,256,'新增库存盘点','warehouse:stocktakes:create','api',NULL,'POST','/warehouse/stocktakes',322,1,NOW(),NOW(),NULL),
(259,256,'确认盘点调账','warehouse:stocktakes:adjust','api',NULL,'POST','/warehouse/stocktakes/{id}/adjust',323,1,NOW(),NOW(),NULL)
...
FROM `permissions`
WHERE `code` IN (
  'warehouse:stocktakes:view',
  'warehouse:stocktakes:targets',
  'warehouse:stocktakes:create',
  'warehouse:stocktakes:adjust'
);
