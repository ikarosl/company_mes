...
) ENGINE=InnoDB AUTO_INCREMENT=50 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='生产批次物料预留与使用表';
...
INSERT INTO `batch_material_usages` VALUES (34,2,7,1,80.0000,80.0000,80.0000,'pcs','used',1,'2026-06-24 13:50:16',NULL,NULL,'2026-06-24 10:32:46',1,'2026-06-24 13:50:16',0,NULL,NULL),(35,2,6,6,80.0000,80.0000,80.0000,'pcs','used',1,'2026-06-24 13:36:07',NULL,NULL,'2026-06-24 10:32:46',1,'2026-06-24 13:36:07',0,NULL,NULL),(36,2,5,5,80.0000,80.0000,80.0000,'pcs','used',1,'2026-06-24 13:36:14',NULL,NULL,'2026-06-24 10:32:46',1,'2026-06-24 13:36:14',0,NULL,NULL),(37,2,4,4,240.0000,240.0000,240.0000,'pcs','used',1,'2026-06-24 13:50:12',NULL,NULL,'2026-06-24 10:32:46',1,'2026-06-24 13:50:12',0,NULL,NULL),(41,1,7,1,100.0000,20.0000,0.0000,'pcs','reserved',NULL,'2026-06-24 11:29:34',NULL,NULL,'2026-06-24 10:33:00',NULL,'2026-06-24 13:53:56',0,NULL,NULL),(42,1,6,6,100.0000,100.0000,0.0000,'pcs','reserved',NULL,'2026-06-24 11:29:19',NULL,NULL,'2026-06-24 10:33:00',NULL,'2026-06-24 13:53:56',0,NULL,NULL),(43,1,5,5,100.0000,100.0000,0.0000,'pcs','reserved',NULL,'2026-06-24 11:29:24',NULL,NULL,'2026-06-24 10:33:00',NULL,'2026-06-24 13:53:56',0,NULL,NULL),(44,1,4,4,300.0000,160.0000,0.0000,'pcs','reserved',NULL,'2026-06-24 11:29:29',NULL,NULL,'2026-06-24 10:33:00',NULL,'2026-06-24 13:53:56',0,NULL,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='物料批次表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `material_batches` VALUES (1,2,'WL-001','PCB供应商',NULL,'2026-06-12',20.0000,'used_up',NULL,NULL,'2026-06-12 13:46:15',1,'2026-06-24 13:50:16',0,NULL,NULL),(4,5,'WL-002','材料有限公司','JSXY-001','2026-06-24',160.0000,'used_up',NULL,1,'2026-06-24 11:22:14',1,'2026-06-24 13:50:12',0,NULL,NULL),(5,4,'WL-003','材料有限公司','JSXY-002','2026-06-24',170.0000,'partial_used',NULL,1,'2026-06-24 11:24:04',1,'2026-06-24 13:36:14',0,NULL,NULL),(6,3,'WL-004','材料有限公司','JSXY-003','2026-06-24',220.0000,'partial_used',NULL,1,'2026-06-24 11:28:21',1,'2026-06-24 13:36:07',0,NULL,NULL);
...
INSERT INTO `production_batches` VALUES (1,1,'PB20260615001',1,100.0000,'doing',4,'2026-06-13','2026-06-16','2026-06-24 13:50:58',NULL,NULL,NULL,'2026-06-15 11:41:08',NULL,'2026-06-24 13:53:56',0,NULL,NULL),(2,2,'SCPC-20260617-001',1,80.0000,'doing',2,'2026-06-16','2026-06-17','2026-06-24 13:37:14',NULL,NULL,NULL,'2026-06-17 11:16:37',NULL,'2026-06-24 13:50:54',0,NULL,NULL);
...
INSERT INTO `products` VALUES (1,'HMITB60T180G-B2','宽带微带环形器',1,1,NULL,'pcs','self_made','[{\"key\": \"频率范围\", \"unit\": \"GHz\", \"value\": \"6-18\"}, {\"key\": \"插入损耗\", \"unit\": \"dB\", \"value\": \"0.8\"}, {\"key\": \"隔离度\", \"unit\": \"dB\", \"value\": \"18\"}]',1,'产品资料样例',NULL,'2026-06-11 14:49:25',NULL,'2026-06-12 09:44:47',0,NULL,NULL),(2,'PCB-CIR-001','环形器控制板',2,1,NULL,'pcs','self_made','[]',1,'PCB 产品资料样例',NULL,'2026-06-11 14:49:25',NULL,'2026-06-16 11:26:59',0,NULL,NULL),(3,'GX-20260615001','带线腔体',3,NULL,NULL,'pcs','purchased','[]',1,NULL,NULL,'2026-06-15 16:12:40',NULL,'2026-06-15 16:12:40',0,NULL,NULL),(4,'GX-20260615002','PCB板',2,NULL,NULL,'pcs','purchased','[]',1,NULL,NULL,'2026-06-15 16:13:29',NULL,'2026-06-15 16:13:29',0,NULL,NULL),(5,'GX-20260615003','粘合剂',3,NULL,NULL,'pcs','purchased','[]',1,NULL,NULL,'2026-06-15 16:14:04',NULL,'2026-06-15 16:14:04',0,NULL,NULL);
...
INSERT INTO `refresh_tokens` VALUES (66,1,'f4ef54cb-82d7-4b59-bfd4-937d53e7c9fe','2026-07-01 14:45:01','2026-06-24 14:45:01');
...
INSERT INTO `work_orders` VALUES (1,'GD-001',1,100.0000,NULL,NULL,2,'released','2026-06-15','2026-06-18',NULL,NULL,'需要提供检测报告',NULL,'2026-06-12 14:53:35',NULL,'2026-06-15 11:41:08',0,NULL,NULL),(2,'gd-002',1,100.0000,'DD-20260624001','航天',2,'released','2026-06-17','2026-06-18',NULL,NULL,NULL,NULL,'2026-06-17 10:55:49',NULL,'2026-06-24 10:17:44',0,NULL,NULL);
...
/*!50001 VIEW `v_batch_material_allocation` AS select `bmu`.`id` AS `usage_id`,`overview`.`batch_id` AS `batch_id`,`overview`.`batch_no` AS `batch_no`,`overview`.`work_order_id` AS `work_order_id`,`overview`.`order_no` AS `order_no`,`overview`.`product_id` AS `product_id`,`overview`.`product_model` AS `product_model`,`overview`.`product_name` AS `product_name`,`overview`.`planned_quantity` AS `planned_quantity`,`pm`.`id` AS `product_material_id`,`pm`.`material_product_id` AS `material_product_id`,`material`.`product_model` AS `material_model`,`material`.`product_name` AS `material_name`,`pm`.`quantity_per_unit` AS `quantity_per_unit`,cast((`pm`.`quantity_per_unit` * `overview`.`planned_quantity`) as decimal(12,4)) AS `current_bom_required_quantity`,`bmu`.`plan_quantity` AS `required_quantity`,`bmu`.`reserved_quantity` AS `reserved_quantity`,`bmu`.`used_quantity` AS `used_quantity`,greatest((`bmu`.`plan_quantity` - `bmu`.`reserved_quantity`),0) AS `unfulfilled_quantity`,coalesce(`bmu`.`unit`,`pm`.`unit`,`material`.`unit`) AS `unit`,`pm`.`is_key_material` AS `is_key_material`,`pm`.`need_batch_record` AS `need_batch_record`,`bmu`.`material_batch_id` AS `material_batch_id`,`mb`.`material_batch_no` AS `material_batch_no`,(case when (`bmu`.`status` = 'cancelled') then 'cancelled' when (`bmu`.`used_quantity` >= `bmu`.`plan_quantity`) then 'used' when (`bmu`.`used_quantity` > 0) then 'partial_used' when (`bmu`.`reserved_quantity` >= `bmu`.`plan_quantity`) then 'allocated' when (`bmu`.`reserved_quantity` > 0) then 'partial_allocated' else 'unallocated' end) AS `material_status`,`bmu`.`status` AS `usage_status`,`bmu`.`recorded_by` AS `recorded_by`,`bmu`.`recorded_at` AS `recorded_at`,`bmu`.`remark` AS `remark`,`bmu`.`created_at` AS `created_at`,`bmu`.`updated_at` AS `updated_at` from ((((`batch_material_usages` `bmu` join `v_production_batch_overview` `overview` on((`overview`.`batch_id` = `bmu`.`batch_id`))) join `product_materials` `pm` on(((`pm`.`id` = `bmu`.`product_materials_id`) and (`pm`.`is_deleted` = 0)))) join `products` `material` on(((`material`.`id` = `pm`.`material_product_id`) and (`material`.`is_deleted` = 0)))) left join `material_batches` `mb` on(((`mb`.`id` = `bmu`.`material_batch_id`) and (`mb`.`is_deleted` = 0)))) where (`bmu`.`is_deleted` = 0) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_material_batch_available` AS select `mb`.`id` AS `material_batch_id`,`mb`.`material_batch_no` AS `material_batch_no`,`mb`.`product_id` AS `material_product_id`,`p`.`product_model` AS `material_model`,`p`.`product_name` AS `material_name`,`p`.`unit` AS `unit`,`mb`.`supplier_name` AS `supplier_name`,`mb`.`protocol_code` AS `protocol_code`,`mb`.`received_date` AS `received_date`,`mb`.`quantity` AS `stock_quantity`,coalesce(`usage_summary`.`reserved_quantity`,0) AS `reserved_quantity`,coalesce(`usage_summary`.`used_quantity`,0) AS `used_quantity`,coalesce(`usage_summary`.`reserved_not_used_quantity`,0) AS `reserved_not_used_quantity`,greatest((`mb`.`quantity` - coalesce(`usage_summary`.`reserved_not_used_quantity`,0)),0) AS `available_quantity`,`mb`.`status` AS `material_batch_status`,`mb`.`remark` AS `remark`,`mb`.`created_at` AS `created_at`,`mb`.`updated_at` AS `updated_at` from ((`material_batches` `mb` join `products` `p` on(((`p`.`id` = `mb`.`product_id`) and (`p`.`is_deleted` = 0)))) left join (select `batch_material_usages`.`material_batch_id` AS `material_batch_id`,sum(`batch_material_usages`.`reserved_quantity`) AS `reserved_quantity`,sum(`batch_material_usages`.`used_quantity`) AS `used_quantity`,sum(greatest((`batch_material_usages`.`reserved_quantity` - `batch_material_usages`.`used_quantity`),0)) AS `reserved_not_used_quantity` from `batch_material_usages` where ((`batch_material_usages`.`is_deleted` = 0) and (`batch_material_usages`.`material_batch_id` is not null) and (`batch_material_usages`.`status` <> 'cancelled')) group by `batch_material_usages`.`material_batch_id`) `usage_summary` on((`usage_summary`.`material_batch_id` = `mb`.`id`))) where (`mb`.`is_deleted` = 0) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2026-06-24 15:18:14
