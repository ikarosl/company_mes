...
DROP TABLE IF EXISTS `batch_material_requirements`;
...
--
-- Dumping data for table `batch_material_requirements`
--

LOCK TABLES `batch_material_requirements` WRITE;
/*!40000 ALTER TABLE `batch_material_requirements` DISABLE KEYS */;
INSERT INTO `batch_material_requirements` VALUES (1,1,4,300.0000,'pcs',NULL,'2026-06-24 10:33:00',NULL,'2026-06-24 13:53:56',0,NULL,NULL),(2,1,5,100.0000,'pcs',NULL,'2026-06-24 10:33:00',NULL,'2026-06-24 13:53:56',0,NULL,NULL),(3,1,6,100.0000,'pcs',NULL,'2026-06-24 10:33:00',NULL,'2026-06-25 15:29:53',0,NULL,NULL),(4,1,7,100.0000,'pcs',NULL,'2026-06-24 10:33:00',NULL,'2026-06-24 13:53:56',0,NULL,NULL),(5,2,4,240.0000,'pcs',NULL,'2026-06-24 10:32:46',1,'2026-06-24 13:50:12',0,NULL,NULL),(6,2,5,80.0000,'pcs',NULL,'2026-06-24 10:32:46',1,'2026-06-24 13:36:14',0,NULL,NULL),(7,2,6,80.0000,'pcs',NULL,'2026-06-24 10:32:46',1,'2026-06-24 13:36:07',0,NULL,NULL),(8,2,7,80.0000,'pcs',NULL,'2026-06-24 10:32:46',1,'2026-06-24 13:50:16',0,NULL,NULL);
/*!40000 ALTER TABLE `batch_material_requirements` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='生产批次物料预留、领料与退料流水表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `batch_material_usages` VALUES (1,2,1,80.0000,7,'reserve',0.0000,'pcs',1,'2026-06-24 13:50:16',NULL,NULL,'2026-06-24 10:32:46',1,'2026-06-24 13:50:16',0,NULL,NULL),(2,2,6,80.0000,6,'reserve',0.0000,'pcs',1,'2026-06-24 13:36:07',NULL,NULL,'2026-06-24 10:32:46',1,'2026-06-24 13:36:07',0,NULL,NULL),(3,2,5,80.0000,5,'reserve',0.0000,'pcs',1,'2026-06-24 13:36:14',NULL,NULL,'2026-06-24 10:32:46',1,'2026-06-24 13:36:14',0,NULL,NULL),(4,2,4,240.0000,4,'reserve',0.0000,'pcs',1,'2026-06-24 13:50:12',NULL,NULL,'2026-06-24 10:32:46',1,'2026-06-24 13:50:12',0,NULL,NULL),(5,1,1,20.0000,7,'reserve',0.0000,'pcs',NULL,'2026-06-24 11:29:34',NULL,NULL,'2026-06-24 10:33:00',NULL,'2026-06-25 16:52:06',1,NULL,'2026-06-25 16:52:06'),(6,1,5,100.0000,5,'reserve',0.0000,'pcs',NULL,'2026-06-24 11:29:24',NULL,NULL,'2026-06-24 10:33:00',NULL,'2026-06-24 13:53:56',0,NULL,NULL),(7,1,4,160.0000,4,'reserve',0.0000,'pcs',NULL,'2026-06-24 11:29:29',NULL,NULL,'2026-06-24 10:33:00',NULL,'2026-06-24 13:53:56',0,NULL,NULL),(8,2,1,0.0000,7,'issue',80.0000,'pcs',1,'2026-06-24 13:50:16',NULL,NULL,'2026-06-24 10:32:46',1,'2026-06-24 13:50:16',0,NULL,NULL),(9,2,6,0.0000,6,'issue',80.0000,'pcs',1,'2026-06-24 13:36:07',NULL,NULL,'2026-06-24 10:32:46',1,'2026-06-24 13:36:07',0,NULL,NULL),(10,2,5,0.0000,5,'issue',80.0000,'pcs',1,'2026-06-24 13:36:14',NULL,NULL,'2026-06-24 10:32:46',1,'2026-06-24 13:36:14',0,NULL,NULL),(11,2,4,0.0000,4,'issue',240.0000,'pcs',1,'2026-06-24 13:50:12',NULL,NULL,'2026-06-24 10:32:46',1,'2026-06-24 13:50:12',0,NULL,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='物料批次表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `production_batches` VALUES (1,1,'PB20260615001',1,100.0000,'doing',4,'2026-06-13','2026-06-16','2026-06-24 13:50:58',NULL,NULL,NULL,'2026-06-15 11:41:08',NULL,'2026-06-25 16:52:06',0,NULL,NULL),(2,2,'SCPC-20260617-001',1,80.0000,'doing',2,'2026-06-16','2026-06-17','2026-06-24 13:37:14',NULL,NULL,NULL,'2026-06-17 11:16:37',NULL,'2026-06-24 13:50:54',0,NULL,NULL);
...
INSERT INTO `users` VALUES (1,1,'admin','$2a$10$lBhLsLyMmRFaviyRy6aiO.DZInv6MAHrm7qSp5OO.yyzD.zvsZgsO','系统管理员','admin@company.local',NULL,1,'2026-06-25 16:51:12','2026-06-11 11:47:00','2026-06-25 16:51:12',NULL),(2,2,'production_manager','$2a$10$lBhLsLyMmRFaviyRy6aiO.DZInv6MAHrm7qSp5OO.yyzD.zvsZgsO','生产主管','production.manager@company.local',NULL,1,NULL,'2026-06-11 11:47:00','2026-06-11 11:47:00',NULL),(3,2,'production_operator','$2a$10$lBhLsLyMmRFaviyRy6aiO.DZInv6MAHrm7qSp5OO.yyzD.zvsZgsO','生产操作员','production.operator@company.local',NULL,1,NULL,'2026-06-11 11:47:00','2026-06-11 11:47:00',NULL),(4,3,'quality_inspector','$2a$10$lBhLsLyMmRFaviyRy6aiO.DZInv6MAHrm7qSp5OO.yyzD.zvsZgsO','质量检验员','quality.inspector@company.local',NULL,1,NULL,'2026-06-11 11:47:00','2026-06-11 11:47:00',NULL);
...
/*!50001 VIEW `v_batch_material_allocation` AS select `requirement`.`id` AS `requirement_id`,`requirement`.`id` AS `usage_id`,`overview`.`batch_id` AS `batch_id`,`overview`.`batch_no` AS `batch_no`,`overview`.`work_order_id` AS `work_order_id`,`overview`.`order_no` AS `order_no`,`overview`.`product_id` AS `product_id`,`overview`.`product_model` AS `product_model`,`overview`.`product_name` AS `product_name`,`overview`.`planned_quantity` AS `planned_quantity`,`pm`.`id` AS `product_material_id`,`pm`.`material_product_id` AS `material_product_id`,`material`.`product_model` AS `material_model`,`material`.`product_name` AS `material_name`,`pm`.`quantity_per_unit` AS `quantity_per_unit`,cast((`pm`.`quantity_per_unit` * `overview`.`planned_quantity`) as decimal(12,4)) AS `current_bom_required_quantity`,`requirement`.`plan_quantity` AS `required_quantity`,coalesce(`summary`.`reserved_quantity`,0) AS `reserved_quantity`,coalesce(`summary`.`issued_quantity`,0) AS `issued_quantity`,coalesce(`summary`.`returned_quantity`,0) AS `returned_quantity`,(coalesce(`summary`.`issued_quantity`,0) - coalesce(`summary`.`returned_quantity`,0)) AS `used_quantity`,greatest((`requirement`.`plan_quantity` - coalesce(`summary`.`reserved_quantity`,0)),0) AS `unfulfilled_quantity`,coalesce(`requirement`.`unit`,`pm`.`unit`,`material`.`unit`) AS `unit`,`pm`.`is_key_material` AS `is_key_material`,`pm`.`need_batch_record` AS `need_batch_record`,`summary`.`material_batch_id` AS `material_batch_id`,`summary`.`material_batch_no` AS `material_batch_no`,(case when ((coalesce(`summary`.`issued_quantity`,0) - coalesce(`summary`.`returned_quantity`,0)) >= `requirement`.`plan_quantity`) then 'used' when ((coalesce(`summary`.`issued_quantity`,0) - coalesce(`summary`.`returned_quantity`,0)) > 0) then 'partial_used' when (coalesce(`summary`.`reserved_quantity`,0) >= `requirement`.`plan_quantity`) then 'allocated' when (coalesce(`summary`.`reserved_quantity`,0) > 0) then 'partial_allocated' else 'unallocated' end) AS `material_status`,`summary`.`recorded_by` AS `recorded_by`,`summary`.`recorded_at` AS `recorded_at`,`summary`.`remark` AS `remark`,`requirement`.`created_at` AS `created_at`,`requirement`.`updated_at` AS `updated_at` from ((((`batch_material_requirements` `requirement` join `v_production_batch_overview` `overview` on((`overview`.`batch_id` = `requirement`.`batch_id`))) join `product_materials` `pm` on(((`pm`.`id` = `requirement`.`product_materials_id`) and (`pm`.`is_deleted` = 0)))) join `products` `material` on(((`material`.`id` = `pm`.`material_product_id`) and (`material`.`is_deleted` = 0)))) left join (select `operation`.`batch_id` AS `batch_id`,`operation`.`product_materials_id` AS `product_materials_id`,(case when (count(distinct (case when (`operation`.`operation_type` = 'reserve') then `operation`.`material_batch_id` end)) = 1) then max((case when (`operation`.`operation_type` = 'reserve') then `operation`.`material_batch_id` end)) else NULL end) AS `material_batch_id`,group_concat(distinct (case when (`operation`.`operation_type` = 'reserve') then `mb`.`material_batch_no` end) order by `mb`.`material_batch_no` ASC separator '、') AS `material_batch_no`,sum((case when (`operation`.`operation_type` = 'reserve') then `operation`.`reserved_quantity` else 0 end)) AS `reserved_quantity`,sum((case when (`operation`.`operation_type` = 'issue') then `operation`.`used_quantity` else 0 end)) AS `issued_quantity`,sum((case when (`operation`.`operation_type` = 'return') then `operation`.`used_quantity` else 0 end)) AS `returned_quantity`,max(`operation`.`recorded_by`) AS `recorded_by`,max(`operation`.`recorded_at`) AS `recorded_at`,substring_index(group_concat(`operation`.`remark` order by `operation`.`id` DESC separator '\n'),'\n',1) AS `remark` from (`batch_material_usages` `operation` left join `material_batches` `mb` on(((`mb`.`id` = `operation`.`material_batch_id`) and (`mb`.`is_deleted` = 0)))) where (`operation`.`is_deleted` = 0) group by `operation`.`batch_id`,`operation`.`product_materials_id`) `summary` on(((`summary`.`batch_id` = `requirement`.`batch_id`) and (`summary`.`product_materials_id` = `requirement`.`product_materials_id`)))) where (`requirement`.`is_deleted` = 0) */;
