  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '日志管理', section: '系统管理', permission: PERMISSIONS.system.page },
      },

      plannedPage('warehouse/inventory', 'warehouse-inventory', '库存管理', '仓储管理', [
        '查看库存',
        '新增入库',
        '出库',
        '发运',
      ...
      plannedPage('warehouse/transactions', 'warehouse-transactions', '出入库管理', '仓储管理', [
        '入库',
        '出库',
        '发运',
        '退料',
      ...
      plannedPage('product/processes', 'product-processes', '生产工序管理', '产品管理', [
        '查看',
        '新增',
        '编辑',
        '启停',
      ...
      plannedPage('product/products', 'product-products', '产品信息管理', '产品管理', [
        '查看',
        '新增',
        '编辑',
        '启停',
      ...
      plannedPage('product/routes', 'product-routes', '工艺路线', '产品管理', [
        '查看',
        '新增',
        '编辑',
        '删除',
      ...
      plannedPage('production/orders', 'production-orders', '工单管理', '生产管理', [
        '查看',
        '新增',
        '编辑',
        '保存草稿',
      ...
      plannedPage('production/dispatch', 'production-dispatch', '派工管理', '生产管理', [
        '查看',
        '派工',
        '改派',
        '一键按默认派工',
      ...
      plannedPage('quality/inspections', 'quality-inspections', '检验记录', '质量管理', [
        '查看',
        '新增',
        '编辑',
        '查看详情',
      ...
      plannedPage('quality/reworks', 'quality-reworks', '返工记录', '质量管理', [
        '查看',
        '新增',
        '编辑',
        '分配返工负责人',
      ...
      plannedPage('worker/tasks', 'worker-tasks', '我的任务', '员工端', [
        '查看我的任务',
        '查看当前工序',
        '查看SOP',
        '开始生产',
      ...
      plannedPage('inspector/tasks', 'inspector-tasks', '检测任务', '检测端', [
        '查看待检测任务',
        '查看规格书',
        '填写检测结果',
        '上传检测文件',
